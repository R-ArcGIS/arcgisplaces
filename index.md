...
In order to use [arcgisplaces](https://github.com/R-ArcGIS/arcgisplaces)
you will need an ArcGIS Developers account. [Get started
...
- [`near_point()`](reference/near_point.md): search for places near a
  location.
- [`within_extent()`](reference/within_extent.md): search for places
  within an extent.
- [`place_details()`](reference/place_details.md): get detailed
  information about the places returned from
  [`near_point()`](reference/near_point.md) or
  [`within_extent()`](reference/within_extent.md).
  - Note: see `fields` for the possible attributes to return for place
    details.

Understanding categories:

- [`categories()`](reference/categories.md): find categories by name or
  ID.

- [`category_details()`](reference/category_details.md): get detailed
  information about the categories returned from
...
[arcgisutils](https://github.com/R-ArcGIS/arcgisutils) is needed for
authentication. The Places API supports either using an API key via
[`auth_key()`](https://rdrr.io/pkg/arcgisutils/man/auth.html) or one
generated via OAuth2 using either
[`auth_client()`](https://rdrr.io/pkg/arcgisutils/man/auth.html) or
[`auth_code()`](https://rdrr.io/pkg/arcgisutils/man/auth.html). See the
[Places API
...
You can **search for places near a location** with
[`near_point()`](reference/near_point.md).
...
[`place_details()`](reference/place_details.md). The possible fields are
[documented
...
[`within_extent()`](reference/within_extent.md). This could be quite
handy for searching within current map bounds, for example.
